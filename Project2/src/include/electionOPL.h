 ...
 */
#ifndef ELECTION_OPL_H_
#define ELECTION_OPL_H_
 ...
 * and outputs results. Extends Election class.
 */
class ElectionOPL : public Election {
    public:
        /**
         * @brief Constructs ElectionOPL object with a user declared file name.
         * 
         * @param files The name of the files containing election data.
         */
        ElectionOPL(vector<string> files);
